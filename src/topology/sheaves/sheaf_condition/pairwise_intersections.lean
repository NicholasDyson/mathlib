...
theorem pushforward_sheaf_of_sheaf_pairwise_intersections
...
theorem pushforward_sheaf_of_sheaf {Y : Top.{v}} {f : X ⟶ Y} {F : presheaf C X}
  (h : F.is_sheaf) : (f _* F).is_sheaf :=
(is_sheaf_iff_is_sheaf_pairwise_intersections _).2
  (pushforward_sheaf_of_sheaf_pairwise_intersections f
    ((is_sheaf_iff_is_sheaf_pairwise_intersections F).1 h))
